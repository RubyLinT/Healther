			...
			TTPopups.prototype={
				setup:function(){
					...
					var oWrap=document.createElement('div'),
						...
						oTitle.style.cssText='height:42px;text-indent:10px;line-height:42px;color:#fff;background:#70B5A8;overflow:hidden;';
						oClose.style.cssText='margin:12px;*margin-top:-30px;width:17px;height:15px;float:right;background:url(../images/close.png) no-repeat center;cursor:pointer';
						oWrap.style.cssText='opacity:0;filter:alpha(opacity:0);position:absolute;z-index:99999;height:'+h+'px;width:'+w+'px;left:50%;top:50%;margin:-'+h/2+'px 0 0 -'+w/2+'px;background:#fff;border:5px solid rgb(31,151,128);';
						oMark.style.cssText='opacity:0;filter:alpha(opacity:0);height:'+vieH+'px;width:'+vieW+'px;position:absolute;z-index:9999;left:0;top:0;background:rgba(0,0,0,0.7);';
